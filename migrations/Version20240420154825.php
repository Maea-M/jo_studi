 ...
 */
final class Version20240420154825 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payement (id INT AUTO_INCREMENT NOT NULL, second_key BINARY(16) DEFAULT NULL, is_paid TINYINT(1) DEFAULT NULL, user_id INT DEFAULT NULL, orders_details_id INT DEFAULT NULL, INDEX IDX_B20A7885A76ED395 (user_id), UNIQUE INDEX UNIQ_B20A7885DED81EA5 (orders_details_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
