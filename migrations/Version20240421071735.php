 ...
 */
final class Version20240421071735 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders_details CHANGE isPaid is_paid TINYINT(1) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders_details CHANGE is_paid isPaid TINYINT(1) DEFAULT NULL');
    }
}
